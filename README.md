    ...
    while wait() do
        ...
        pcall(function()
            if not GetCurrentVehicle() and tick() - (LastNotif or 0) > 5 then
                LastNotif = tick()
                SendNotification("Fu Kang Hub", "มึงขึ้นรถก่อนsus")
            else
...
local venyx = library.new("Fu Kang Hub", 5013109572)
...
SecondSection1:addButton("X2sleep#2433", function() setclipboard("X2sleep#2433") jailbreakNotify("Copied to clipboard.") end)
...
SecondSection1:addButton("https://discord.gg/w2FD9nwm6Y", function() setclipboard("https://discord.gg/w2FD9nwm6Y") jailbreakNotify("Copied to clipboard.") end)
